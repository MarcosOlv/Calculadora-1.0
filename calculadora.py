...
cor1 = "#212120" #preto
cor2 = "#000f1c" #cor azul
cor3 = "#d9d9d9" #cinza/branco
cor4 = "#ffa200" #laranja
cor5 = "#ffffff" #branco
...
app_label = Label(frame_display, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivy 18 '), bg=cor2, fg=cor5)
...
b_18 = Button(frame_corpo, command = lambda: entrar_valores('0'), text="0", width=11, height=2, bg=cor3, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_18.place(x=0, y=208)
b_16 = Button(frame_corpo, command = lambda: entrar_valores('.'), text=".", width=5, height=2, bg=cor3, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_16.place(x=118, y=208)
b_17 = Button(frame_corpo, command = calculo, text="=", width=5, height=2, bg=cor4, fg=cor5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
